return function(DSSModName, DSSCoreVersion, MenuProvider)
    ...
    function dssmod:post_render()
        ...
        local taintedClosetOverride = Isaac.GetPlayer():GetData().taintedCharacterLockedInCloset
        if ((isCore and inFirstRoom) or taintedClosetOverride) and not isOpen and DeadSeaScrollsMenu.GetMenuHintSetting() == 1 then
